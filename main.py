...
def search():
    ...
    if response.status_code==200: #200 means the request was successful,404 means not found,401 means unauthorized
       ...
       for item in data.get('items',[]):
            ...
            image_url=image_links.get('thumbnail') if 'thumbnail' in image_links else 'N/A'
...
Button(root,image=Logout_image,bg="#0099ff",cursor="hand1",command=lambda:root.destroy()).place(x=1120,y=20)
